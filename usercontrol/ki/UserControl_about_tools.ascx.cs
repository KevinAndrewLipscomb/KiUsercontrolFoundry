    ...
    public partial class TWebUserControl_about_tools: ki_web_ui.usercontrol_class
    {
        ...
        protected override void OnInit(System.EventArgs e)
        {
            ...
            if (Session["UserControl_about_tools.p"] != null)
            {
                ...
                p.be_loaded = IsPostBack && ((Session["UserControl_member_binder_PlaceHolder_content"] as string) == "UserControl_about_tools");
            }
            else
            {
                p.be_loaded = false;
...
namespace UserControl_about_tools.Units
{
    public class UserControl_about_tools
    {
    } // end UserControl_about_tools
