<%@ Control Language="c#" AutoEventWireup="false" Codebehind="UserControl_session_interrupted.pas" Inherits="UserControl_session_interrupted.TWebUserControl_session_interrupted"%>
