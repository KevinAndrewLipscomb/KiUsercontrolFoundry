...
namespace UserControl_about_by
{
    ...
    public class TWebUserControl_about_by: ki_web_ui.usercontrol_class
    {
        private p_type p;
...
namespace UserControl_about_by.Units
{
    public class UserControl_about_by
    {
    } // end UserControl_about_by
